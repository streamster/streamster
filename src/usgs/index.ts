...
class usgs implements USGSService {
  ...
  public update(queryParameters: queryParameters, options: usgsFetchOptions = { format: "default" }) {
    this.queryParameters = updateQueryParameters(this.queryParameters, queryParameters);
